      ...
      function Storage() {
        ...
        this._resolveIcon = function (icon) {
          ...
          while (true) {
            ...
            if (
              counter > 5 ||
              this._resolved[icon.prefix][parentIcon] === void 0
            ) {
            ...
            parent =
              this[isAlias ? "_aliases" : "_icons"][icon.prefix][parentIcon]
      ...
      function SVG(item) {
        ...
        this.height = function (width, inline, precision) {
          ...
          return calculateDimension(
            width,
            (inline ? this.item.inlineHeight : this.item.height) /
              this.item.width,
            precision
          )
        }
      ...
      local.getImageAttributes = function (image) {
        ...
        if (results["class"] !== void 0) {
          ...
          if (image.parser && image.parser.filterClasses !== void 0) {
            results["class"] = image.parser.filterClasses(
              image,
              results["class"]
            )
          }
    ...
    ;(function (Iconify, local, config) {
      ...
      var finders = {
        iconify: {
          ...
          selectorLoading:
            "." + imageClass + negativeSelectors + loadingSelector,
